...
func printTracks(tracks []*Track) {
	...
	tw.Flush() // calculate column widths; formats the entire table and writes it to os.Stdout
}
...
func main() {
	...
	sort.Sort(customSort{tracks, func(x, y *Track) bool { // primary sort key Title, secondary key Year, tertiary key Length
		if x.Title != y.Title {
